            ...
            <div class="col-sm-8 col-sm-offset-2">
                ...
                <div class="blog-comments fix">
                    ...
                    <div class="comment-form">
                        <h2>用户注册</h2>
                        <form  id="myForm"  action="${pageContext.request.contextPath}/user/userRegist.do" class="moon-form" method="post">
                            <div class="input-box">
                                <input type="text" placeholder="用户名" name="username" id="username">
                            </div>
                            <div class="input-box ">
                                <input type="text" placeholder="手机号码" name="telephone" id="telephone">
