                                        ...
                                        <table class="table-cart data-table table" id="shopping-cart-tables">
                                            ...
                                            <tr>
                                                <td><div class="cart-items fix">
                                                    <a href="#" class="cart-image"><img src="${pageContext.request.contextPath}/product/${order.product.image}" alt="" /></a>
                                                    <div class="cart-item-content fix">
                                                        <h3 class="title"><a href="#">${order.product.name}</a></h3>
                                                        <h3 class="title"><a href="#">￥${order.product.price}</a></h3>


                                                    </div>
                                                </div></td>
                                                <td><span class="cart-price">${order.oid}</span></td>
                                                <td><span class="cart-price">${order.user.telephone}</span></td>
                                                <td><span class="cart-price">￥${order.order_price}</span></td>
                                                ...
                                                <c:if test="${order.order_state eq  0}">
                                                    <td><span class="cart-price">代收货</span></td>
                                                    <td><span class="cart-price"><a href="${pageContext.request.contextPath}/purse/confirmProduct.do?uid=${order.sell_uid}&price=${order.product.price}&oid=${order.oid}">确认收货</a></span></td>
                                                </c:if>
                                ...
                                <div class="table-responsive">
                                    <fieldset>
                                        <table class="table-cart data-table table" id="shopping-cart-table">
                                            ...
                                            <tr>
                                                <td><div class="cart-items fix">
                                                    <a href="#" class="cart-image"><img src="${pageContext.request.contextPath}/product/${sellOrder.product.image}" alt="" /></a>
                                                    <div class="cart-item-content fix">
                                                        <h3 class="title"><a href="#">${sellOrder.product.name}</a></h3>
                                                        <h3 class="title"><a href="#">￥${sellOrder.product.price}</a></h3>
                                                    </div>
                                                </div></td>
                                                <td><span class="cart-price">${sellOrder.oid}</span></td>
                                                <td><span class="cart-price">${sellOrder.user.telephone}</span></td>

                                                <td><span class="cart-price">￥${sellOrder.order_price}</span></td>
                                                ...
                                                <c:if test="${sellOrder.order_state eq 0}">
                                                    <td><span class="cart-price">待发货</span></td>
                                                </c:if>
